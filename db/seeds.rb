...
#Record:
 Record.create(:member_id => 1, :weight => "76", :created_at => "2014-08-15")
 Record.create(:member_id => 1, :weight => "74", :created_at => "2014-08-16")
 Record.create(:member_id => 1, :weight => "73", :created_at => "2014-08-17")
 Record.create(:member_id => 1, :weight => "71", :created_at => "2014-08-18")
 Record.create(:member_id => 1, :weight => "72", :created_at => "2014-08-19")
 Record.create(:member_id => 1, :weight => "78", :created_at => "2014-08-20")
 Record.create(:member_id => 1, :weight => "71", :created_at => "2014-08-21")
 Record.create(:member_id => 1, :weight => "73", :created_at => "2014-08-22")
 Record.create(:member_id => 2, :weight => "76", :created_at => "2014-08-15")
 Record.create(:member_id => 2, :weight => "74", :created_at => "2014-08-16")
 Record.create(:member_id => 2, :weight => "73", :created_at => "2014-08-17")
 Record.create(:member_id => 2, :weight => "71", :created_at => "2014-08-18")
 Record.create(:member_id => 2, :weight => "72", :created_at => "2014-08-19")
 Record.create(:member_id => 2, :weight => "78", :created_at => "2014-08-20")
 Record.create(:member_id => 2, :weight => "71", :created_at => "2014-08-21")
 Record.create(:member_id => 2, :weight => "73", :created_at => "2014-08-22")
 Record.create(:member_id => 3, :weight => "76", :created_at => "2014-08-15")
 Record.create(:member_id => 3, :weight => "74", :created_at => "2014-08-16")
 Record.create(:member_id => 3, :weight => "73", :created_at => "2014-08-17")
 Record.create(:member_id => 3, :weight => "71", :created_at => "2014-08-18")
 Record.create(:member_id => 3, :weight => "72", :created_at => "2014-08-19")
 Record.create(:member_id => 3, :weight => "78", :created_at => "2014-08-20")
 Record.create(:member_id => 3, :weight => "71", :created_at => "2014-08-21")
 Record.create(:member_id => 3, :weight => "73", :created_at => "2014-08-22")
 Record.create(:member_id => 4, :weight => "76", :created_at => "2014-08-15")
 Record.create(:member_id => 4, :weight => "74", :created_at => "2014-08-16")
 Record.create(:member_id => 4, :weight => "73", :created_at => "2014-08-17")
 Record.create(:member_id => 4, :weight => "71", :created_at => "2014-08-18")
 Record.create(:member_id => 4, :weight => "72", :created_at => "2014-08-19")
 Record.create(:member_id => 4, :weight => "78", :created_at => "2014-08-20")
 Record.create(:member_id => 4, :weight => "71", :created_at => "2014-08-21")
 Record.create(:member_id => 4, :weight => "73", :created_at => "2014-08-22")
...
#
#Leader:
#	Leader.new(:email => "graham@gcd.com")
#	Leader.new(:email => "alan@gcd.com")
#	Leader.new(:email => "david@gcd.com")
#	Leader.new(:email => "jessica@gcd.com")
#	Leader.new(:email => "edel@gcd.com")
#	Leader.new(:email => "feebee@gcd.com")
#	Leader.new(:email => "barry@gcd.com")
#	Leader.new(:email => "eoin@gcd.com")
#	Leader.new(:email => "jennifer@gcd.com")
#
##Member:
#	Member.new(:plan_id => "1", :group_id => "1", :target => "65", :email => "tom@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "1", :group_id => "1", :target => "96", :email => "ger@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "1", :group_id => "1", :target => "75", :email => "tara@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "2", :group_id => "2", :target => "35", :email => "roisin@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "2", :group_id => "2", :target => "43", :email => "ricky@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "2", :group_id => "2", :target => "23", :email => "stone@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "2", :group_id => "3", :target => "14", :email => "laura@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "3", :group_id => "3", :target => "60", :email => "tim@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "3", :group_id => "4", :target => "47", :email => "shiguang@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "3", :group_id => "4", :target => "23", :email => "ting@gcd.com", :note => "Hello.")
#	Member.new(:plan_id => "3", :group_id => "5", :target => "47", :email => "avi@gcd.com", :note => "Hello.")
